        ...
        <el-dialog :title="title" :visible.sync="open" width="500px">
          <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            ...
            <el-form-item label="实际座园地备注" prop="actualRemarks">
              <el-input
                v-model="form.actualRemarks"
                placeholder="实际座园地备注"
              />
            </el-form-item>
            <el-form-item label="实际座园地是否流转(1是,0否)" prop="actualFlow">
              <el-input
                v-model="form.actualFlow"
                placeholder="实际座园地是否流转(1是,0否)"
              />
            </el-form-item>
            ...
            <el-form-item label="人口田备注" prop="personRemarks">
              <el-input
                v-model="form.personRemarks"
                placeholder="人口田备注"
              />
            </el-form-item>
            <el-form-item label="人口田是否流转(1是,0否)" prop="personFlow">
              <el-input
                v-model="form.personFlow"
                placeholder="人口田是否流转(1是,0否)"
              />
            </el-form-item>
