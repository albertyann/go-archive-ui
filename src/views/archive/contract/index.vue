      ...
      <el-card class="box-card">
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
          <el-form-item label="合同名称" prop="contractTitle">
            <el-input v-model="queryParams.contractTitle" placeholder="合同名称" clearable size="small" style="width: 160px"
              @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="甲方" prop="partyA">
            <el-input v-model="queryParams.partyA" placeholder="甲方" clearable size="small" style="width: 160px"
              @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="乙方" prop="partyB">
            <el-input v-model="queryParams.partyB" placeholder="乙方" clearable size="small" style="width: 160px"
              @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-permisaction="['admin:contract:add']" type="primary" icon="el-icon-plus" size="mini"
        ...
        <el-table v-loading="loading" :data="contractList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="合同标题" prop="contractTitle" />
          <el-table-column label="合同状态" prop="status" />
          <el-table-column label="甲方" prop="partyA" />
        ...
        <el-dialog :title="title" :visible.sync="open" width="800px" @close="cleanFile">
          <el-form ref="form" :model="form" :rules="rules" label-width="120px">
            ...
            <el-form-item label="合同生效日期" prop="effectiveDate" required>
              <el-date-picker v-model="form.effectiveDate" type="date" placeholder="合同生效日期" />
            </el-form-item>
            <el-form-item label="合同到期日期" prop="expiryDate">
              <el-date-picker v-model="form.expiryDate" type="date" placeholder="合同到期日期" />
            </el-form-item>
            ...
            <el-form-item label="收款状态" prop="payStatus">
              <el-select v-model="form.payStatus" placeholder="收款状态" clearable>
            ...
            <el-form-item label="附件" prop="sys_app_logo">
              <el-upload ref="sys_app_logo" :headers="headers" :file-list="fileList" :action="sys_app_logoAction"
                style="float:left" :before-upload="sys_app_logoBeforeUpload" list-type="picture-card"
                :show-file-list="true" :on-success="uploadSuccess">
  ...
  export default {
    ...
    methods: {
      ...
      uploadSuccess(response, file, fileList) {
        const image_path = response.data.full_path
