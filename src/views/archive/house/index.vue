        ...
        <el-table v-loading="loading" :data="houseList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template slot-scope="scope">
              <el-button v-permisaction="['archive:house:edit']" size="mini" type="text" icon="el-icon-document"
                @click="showDetail(scope.row)">查看</el-button>
              <el-button v-permisaction="['archive:house:edit']" size="mini" type="text" icon="el-icon-edit"
