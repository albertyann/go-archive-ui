      ...
      <el-card class="box-card">
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
          ...
          <el-form-item label="身份证" prop="idCard">
            <el-input v-model="queryParams.idCard" placeholder="身份证" clearable size="small" style="width: 180px"
              @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="手机" prop="phone">
            <el-input v-model="queryParams.phone" placeholder="手机" clearable size="small" style="width: 120px"
              @keyup.enter.native="handleQuery" />
          </el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-permisaction="['admin:tbMember:add']" type="primary" icon="el-icon-plus" size="mini"
              @click="handleAdd">新增
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-permisaction="['admin:tbMember:remove']" type="danger" icon="el-icon-delete" size="mini"
              :disabled="multiple" @click="handleDelete">删除
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-permisaction="['archive:tbMember:export']" type="primary" icon="el-icon-download" size="mini"
        ...
        <el-drawer :title="title" :visible.sync="open" size="830px">
          <el-form ref="form" :model="form" :rules="rules" size="medium" label-width="100px">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="身份证" prop="idCard">
                  <el-input v-model="form.idCard" placeholder="请输入身份证" clearable :style="{width: '100%'}"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="证件有效期">
                  <el-input v-model="form.idCardStart" :style="{width: '120px'}"></el-input>
                  <span> 至 </span>
                  <el-input v-model="form.idCardEnd" :style="{width: '130px'}"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="出生日期" prop="birthday">
                  <el-input v-model="form.birthday" readonly clearable :style="{width: '100%'}">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label=" 年龄" prop="age">
                  <el-input v-model="form.age" placeholder="年龄" show-word-limit readonly="readonly"
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="户籍类型" prop="hukouType">
                  <el-select v-model="form.hukouType" clearable :style="{width: '100%'}">
                    <el-option v-for="(item, index) in hukouTypeOptions" :key="index" :label="item.label"
                      :value="item.value" :disabled="item.disabled"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="8">
                <el-form-item label="户籍编号" prop="hukouNo">
                  <el-input v-model="form.hukouNo" :maxlength="5" show-word-limit clearable
                    :style="{width: '100%'}"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="是否户主" prop="isHolder">
                  <el-select v-model="form.isHolder" placeholder="请选择是否户主" clearable :style="{width: '100%'}">
                    <el-option v-for="(item, index) in isHolderOptions" :key="index" :label="item.label"
              ...
              <el-col :span="12">
                <el-form-item label="户主关系" prop="holderRelation">
                  <el-select v-model="form.holderRelation" placeholder="请选择户主关系" clearable :style="{width: '100%'}">
                    <el-option v-for="(item, index) in holderRelationOptions" :key="index" :label="item.label"
                      :value="item.value" :disabled="item.disabled"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12">
                <el-form-item label="婚姻状况" prop="married">
                  <el-select v-model="form.married" placeholder="请选择婚姻状况" clearable :style="{width: '100%'}">
                    <el-option v-for="(item, index) in marriedOptions" :key="index" :label="item.label"
                      :value="item.value" :disabled="item.disabled"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="学历" prop="diploma">
                  <el-select v-model="form.diploma" placeholder="请选择学历" clearable :style="{width: '100%'}">
                    <el-option v-for="(item, index) in diplomaOptions" :key="index" :label="item.label"
                      :value="item.value" :disabled="item.disabled"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="残疾" prop="disability">
                  <el-select v-model="form.disability" placeholder="请选择残疾" clearable :style="{width: '100%'}">
                    <el-option v-for="(item, index) in disabilityOptions" :key="index" :label="item.label"
                      :value="item.value" :disabled="item.disabled"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="残障等级" prop="disabilityLevel">
                  <el-select v-model="form.disabilityLevel" placeholder="请选择残障等级" clearable :style="{width: '100%'}">
                    <el-option v-for="(item, index) in disabilityLevelOptions" :key="index" :label="item.label"
              ...
              <el-col :span="12">
                <el-form-item label="是否低保" prop="guarantee">
                  <el-select v-model="form.guarantee" placeholder="请选择是否低保" clearable :style="{width: '100%'}">
                    <el-option v-for="(item, index) in guaranteeOptions" :key="index" :label="item.label"
                      :value="item.value" :disabled="item.disabled">
                    </el-option>
                  </el-select>
                </el-form-item>
              ...
              <el-col :span="12">
                <el-form-item label="是否拆迁" prop="demolition">
                  <el-select v-model="form.demolition" placeholder="请选择是否拆迁" clearable :style="{width: '100%'}">
                    <el-option v-for="(item, index) in demolitionOptions" :key="index" :label="item.label"
                      :value="item.value" :disabled="item.disabled">
                    </el-option>
                  </el-select>
                </el-form-item>
            ...
            <el-row>
              <el-form-item label="服务处所" prop="employer">
                <el-input v-model="form.workplace" placeholder="服务处所" :maxlength="100" show-word-limit clearable
                  :style="{width: '100%'}"></el-input>
              </el-form-item>
              <el-form-item label="工作单位" prop="employer">
                <el-input v-model="form.employer" placeholder="请输入工作单位" :maxlength="100" show-word-limit clearable
                  :style="{width: '100%'}"></el-input>
              </el-form-item>
